...
export default function PreviousRuns_HomeScreen() {
    ...
    return (
        <ScreenLinearBackground>
            ...
            <Button title="Send message" onPress={() => onPressHandler("hi how are you! Great day aye. I'm Maya and I just got the google API working. HOW EXCITING!!! SHAME it sounds like a robot still. All this work for it to just sound like a bloody robot!")} />
        </ScreenLinearBackground>
    )
};
