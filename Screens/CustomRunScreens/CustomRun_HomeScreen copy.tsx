...
export default function CustomRun_HomeScreen() {
    ...
    // if((state.option1 === 'TIME' && state.option2 === 'DISTANCE') || (state.option1 === 'DISTANCE' && state.option2 === 'TIME')){
    //     //I want to run 5k in 2mins
    // }

    // if((state.option1 === 'TIME' && state.option2 === 'SPEED') || (state.option1 === 'SPEED' && state.option2 === 'TIME')){
    //     //I want to JOG for 5 mins
    // }

    // if((state.option1 === 'SPEED' && state.option2 === 'DISTNACE') || (state.option1 === 'DISTANCE' && state.option2 === 'SPEED')){
    //     //I JOG for 5k
    // }
